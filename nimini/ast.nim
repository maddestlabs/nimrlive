...
type
  ExprKind* = enum
    ...
    ekDeref,       # expr[]
    ekDot,         # expr.field
    ekObjConstr    # TypeName(field1: val1, field2: val2)
  ...
  Expr* = ref object
    ...
    of ekCall:
      funcName*: string
      args*: seq[Expr]
      namedArgs*: seq[tuple[name: string, value: Expr]]  # Named parameters: name: value
    of ekArray:
      elements*: seq[Expr]
    of ekMap:
    ...
    of ekObjConstr:
      objTypeName*: string
      objFields*: seq[tuple[name: string, value: Expr]]  # Field initializers
...
proc newCall*(name: string; args: seq[Expr]; namedArgs: seq[tuple[name: string, value: Expr]] = @[]; line=0; col=0): Expr =
  Expr(kind: ekCall, funcName: name, args: args, namedArgs: namedArgs, line: line, col: col)
...
proc newObjConstr*(typeName: string; fields: seq[tuple[name: string, value: Expr]]; line=0; col=0): Expr =
  Expr(kind: ekObjConstr, objTypeName: typeName, objFields: fields, line: line, col: col)
...
proc newObjectType*(fields: seq[ObjectField]): TypeNode =
